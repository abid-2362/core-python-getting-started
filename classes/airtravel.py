...
class Flight:
    ...
    def relocate_passenger(self, from_seat, to_seat):
        """Relocate a apassenger to a different seat
    ...
    # 2 Generator function expressions are used here.
...
# Derived Class AirbusA319 derived from Aircraft class
...
def make_flights():
    ...
    f.allocate_seat("15E", "Mehboob Alam")
